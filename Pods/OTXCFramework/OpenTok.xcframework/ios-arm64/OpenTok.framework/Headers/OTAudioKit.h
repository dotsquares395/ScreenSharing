 ...
 * S1C1 S1C2 S2C1 S2C2 ...
 */
@property(nonatomic, assign) int16_t* _Nullable sampleBuffer;
/**
 ...
 */
@property(nonatomic, assign) uint32_t numberOfChannels;
/**
 * The number of samples per channel.
 */
@property(nonatomic, assign) uint32_t numberOfSamples;
