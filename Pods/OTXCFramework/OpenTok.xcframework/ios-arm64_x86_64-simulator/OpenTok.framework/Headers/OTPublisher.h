...
typedef NS_ENUM(NSInteger, OTCameraCaptureResolution) {
    ...
    /**
     * 1080p resolution (1920x1080), the highest available camera capture resolution
     * supported in the OpenTok iOS SDK, or the closest resolution supported on the device.
     * For important considerations in using 1080p video, see this
     ...
     */
    OTCameraCaptureResolutionHigh1080p, // AVCaptureSessionPreset1920x1080
